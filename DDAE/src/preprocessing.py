...
if len(sys.argv) < 4:
    print ("Usage: python src/preprocessing.py data.h5 list_noisy list_clean")
    sys.exit(1) 
...
FRAMEWIDTH = 2
FBIN = FRAMESIZE//2+1
data_name = "src/dataset/" + sys.argv[1]

noisylistpath = "src/dataset/" + sys.argv[2] #"/mnt/hd-01/user_sylar/MHINTSYPD_100NS/trnoisylist"
...
cleanlistpath = "src/dataset/" + sys.argv[3] #"/mnt/hd-01/user_sylar/MHINTSYPD_100NS/trcleanlist"
